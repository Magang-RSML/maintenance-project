...
<!-- <div class="container my-4"> -->
    ...
    <a href="{{ route('it_staff.workorders.create') }}" class="btn btn-success mb-3">Tambahkan Laporan</a>
        ...
        <table class="table table-dark table-hover text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('it_staff.workorders.edit', $workOrder) }}" class="btn btn-warning btn-sm">Edit</a>
                        <form action="{{ route('it_staff.workorders.destroy', $workOrder) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
